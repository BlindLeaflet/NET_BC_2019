...
namespace NET_BLACKJACK
{
    public class Game
    {
        private IBlackjackPlajer PlayerOne;
        private IBlackjackPlajer PlayerTwo;
        private Deck Deck;
        ...
        public void Loop()
        {
            ...
            while (!PlayerOne.isGameCompleated() && PlayerOne.WantCard())
            {
                PlayerOne.GiveCard(Deck.GetCard());
            }
            ...
            else
            {
                ...
                // are not over 21 and he wants another card.
                while (!PlayerTwo.isGameCompleated() && PlayerTwo.WantCard())
                {
                    PlayerTwo.GiveCard(Deck.GetCard());
                }
